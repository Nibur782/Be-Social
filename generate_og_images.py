...
CARDS = [
    ...
    # ---- BLOG ----
    {
        "out": "blog/og-blog-index.jpg",
        "title": "Blog — konkretna wiedza o marketingu",
        "subtitle": "Artykuły z pracy na realnych kontach i danych. Meta Ads, Google Ads, atrybucja, AI, SEO/GEO.",
        "accent_text": "DAWIDRUBIN.PL / BLOG",
        "badge": "Blog",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-wizytowka-google.jpg",
        "title": "Wizytówka Google Business — jak założyć i skonfigurować",
        "subtitle": "Weryfikacja, kategorie, opis, zdjęcia, opinie. Plus 12 błędów kosztujących widoczność.",
        "accent_text": "DAWIDRUBIN.PL / BLOG",
        "badge": "Lokalny",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-meta-advantage-plus.jpg",
        "title": "Meta Advantage+ — czy warto w 2026?",
        "subtitle": "Kiedy ADV+ wymiata, kiedy zabija konto. Praktyka z budżetów 100k+ PLN/mies.",
        "accent_text": "DAWIDRUBIN.PL / META ADS",
        "badge": "Meta",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-performance-max.jpg",
        "title": "Performance Max — jak działa i kiedy warto",
        "subtitle": "Co PMax robi pod maską, jak go karmić sygnałami, jak nie dać mu zjeść brandu.",
        "accent_text": "DAWIDRUBIN.PL / GOOGLE ADS",
        "badge": "PMax",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-targetowanie-kreacja.jpg",
        "title": "Targetowanie kreacją — wygrywa nowy filtr",
        "subtitle": "Po deathwatchu cookie-based targetowania kreacja przejęła rolę głównego filtra publiczności.",
        "accent_text": "DAWIDRUBIN.PL / KREACJA",
        "badge": "Hook",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-google-ads-przezytek.jpg",
        "title": "Czy Google Ads to przeżytek?",
        "subtitle": "AI Overviews, ChatGPT Search, Performance Max. Co działa w 2026 i co zniknie.",
        "accent_text": "DAWIDRUBIN.PL / STRATEGIA",
        "badge": "2026",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-seo-vs-geo.jpg",
        "title": "SEO vs GEO — pozycjonowanie w dobie AI",
        "subtitle": "Generative Engine Optimization. Jak optymalizować pod ChatGPT, Perplexity, Gemini i AI Overviews.",
        "accent_text": "DAWIDRUBIN.PL / SEO + GEO",
        "badge": "AI Search",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-minimalny-budzet.jpg",
        "title": "Minimalny budżet reklamowy — ile potrzebujesz",
        "subtitle": "Konkretne progi per platforma: Meta, Google, TikTok, LinkedIn. Plus wzór dla Twojego biznesu.",
        "accent_text": "DAWIDRUBIN.PL / BUDŻET",
        "badge": "Strategia",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-conversions-api.jpg",
        "title": "Conversions API i Server-Side Tracking",
        "subtitle": "Po iOS 14.5 pixel traci 30-50% sygnału. CAPI i sGTM odzyskują dane i poprawiają ROAS o 15-30%.",
        "accent_text": "DAWIDRUBIN.PL / TRACKING",
        "badge": "CAPI",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-ai-w-marketingu.jpg",
        "title": "AI w marketingu — 7 zastosowań ChatGPT",
        "subtitle": "Briefy kreacji, analiza feedbacku, Custom GPTs uczone na danych firmy. Z promptami i przykładami.",
        "accent_text": "DAWIDRUBIN.PL / AI",
        "badge": "ChatGPT",
        "background_image": None,
    },
    {
        "out": "blog/og-blog-atrybucja-multi-touch.jpg",
        "title": "Atrybucja multi-touch — dlaczego last-click kłamie",
        "subtitle": "Last-click ignoruje 4-12 styków z marką przed konwersją. Jak budować DDA, MER i geo-lift.",
        "accent_text": "DAWIDRUBIN.PL / ATRYBUCJA",
        "badge": "DDA",
        "background_image": None,
    },
]
